...
if __name__ == "__main__":
    ...
    generator = Generator(k_dim=8195, input_dim=4, hidden=1024, output_dim=3, device=device)
    gen_path = './checkpoints/2024.04.28 14-08-55_merged_8195_generator_epoch_700000.pt'
    gen_params = torch.load(gen_path, map_location=device)
    ...
    for i in tqdm(range(len(content_names))):
        ...
        imgs = run_inference(generator, device, im_1, im_2, gen_steps=steps, strength=strength);
