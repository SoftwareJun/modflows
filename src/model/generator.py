...
def gen_preprocess(pil_image, crop=False, image=False, rand_trans=False):
    im = pil_image
...
class Generator(nn.Module):
    ...
    def __init__(self, k_dim, input_dim, hidden, output_dim, device, generator_type="B6"):
        super().__init__()
        self.k_dim = k_dim
        if generator_type == "B6":
