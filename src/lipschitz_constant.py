...
from model.generator import gen_preprocess
...
if __name__ == "__main__":
    num_samples = 50000  
    path_dir = "V7_generator_epoch_700000"  # Your directory name
    print("\n",path_dir)
    ...
    for idx in tqdm(range(len(stylization_results))):
        x = gen_preprocess(Image.open(stylization_results[idx]))
        y = gen_preprocess(Image.open(content_images[idx]))
